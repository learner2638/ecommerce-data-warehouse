...
-- ODS 层
-- 说明：
-- 1. ODS 字段按当前下游 DWD SQL 反推，足够支撑你现有链路
-- 2. 如果你本地 CSV 列顺序不同，再按真实原始文件微调
-- =========================
...
-- =========================
-- 数据质量结果表
-- 字段按 quality/create_ads_data_quality_report.sql 对齐
-- =========================
